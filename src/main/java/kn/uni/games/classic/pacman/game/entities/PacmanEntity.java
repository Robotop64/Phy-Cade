...
//  {
//    absPos.rounded().use(g::translate);
//
...
//    g.rotate(Math.toRadians(-θ));
//
//    absPos.rounded().multiply(-1).use(g::translate);
//  }
//
//  @Override
...
//    if (movable)
//    {
//      TotalPosition tp          = gameState.map.splitPosition(absPos);
...
//        absPos = absPos.add(currentDirection.toVector().multiply(v.x));
//    }
//
...
//    }
//
//    DebugDisplay.setData(gameState, DebugDisplay.DebugType.Player, DebugDisplay.DebugSubType.PlayerPosition, "[Pos: " + this.absPos.toString() + "]");
