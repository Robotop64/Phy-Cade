...
public class OnScreenKeyboard extends UIScreen {
    ...
    private enum LayoutHead {num, numDE, extra}

    private enum LayoutBody {specialSigns1, specialSigns2, math, logic, mathSets, roman, currency, DE, GREEK}

    private enum Languages {DE, GREEK}
